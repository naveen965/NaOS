;NaOS --- The NaOS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE NaOS_VER '1.0'	 ;OS version number
	%DEFINE NaOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as NaOS and its programs
...
option_screen:
	...
	mov cx, 00111111b		; Colour: white text on light blue
	...
	os_init_msg		db '============== ********* Welcome to NaOS ********* ===============', 0
	os_version_msg		db 'Version ', NaOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', NaOS_VER, 0

	dialog_string_1		db 'Welcome to NaOS Operating System', 0
...
os_draw_background1:
	...
	mov cx, 10001111b		; Colour: white text on dark gray
	...
	mov ah, 09h			; Draw red bar at bottom
	mov bh, 0
	mov cx, 80
	mov bl, 01001111b
	mov al, ' '
